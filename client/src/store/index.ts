...
export interface AppFunctionComponent<RequiredProps, StateToProps extends (...args: any) => any, ComponentState = {}> extends FunctionComponent<RequiredProps & ReturnType<StateToProps> & ConnectedProps<typeof connector>> {};
